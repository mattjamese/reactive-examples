...
public class UserControllerTest {
    ...
    public  void setup(){
        List<String> statements = Arrays.asList("DROP TABLE IF EXISTS users ;",
                "CREATE TABLE users ( id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR(100) NOT NULL, age integer,salary decimal,email VARCHAR(100),insertDate date);");
    ...
    public void createUser(){
        User user = new User(null,"Rahul Dravid",45,new BigDecimal("10000.00"), "suman.das@abc.com", LocalDate.now());
    ...
    public void updateUser(){
        ...
        User user = new User(null,"Suman Das",31,new BigDecimal("12345"), "suman.das@abc.com", LocalDate.now());
